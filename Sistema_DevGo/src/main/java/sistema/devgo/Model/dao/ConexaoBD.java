...
public class ConexaoBD {
    ...
    private static final String SERVIDOR = "10.135.147.26";//caminho do servidor do BD
    ...
    private static final String USUARIO = "admin"; //nome do usuário do banco de dados
    private static final String SENHA = "123"; //senha do usuário do banco de dados
